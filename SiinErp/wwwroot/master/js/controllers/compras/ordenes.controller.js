(function () {
    ...
    AppController.$inject = ['$location', '$cookies', '$scope', 'ComOrdenService', 'ComOrdenDetService', 'GenTerceroService', 'CarPlazoPagoService', 'GenTablaDetService', 'InvArticuloService', 'GenTipoDocService'];
