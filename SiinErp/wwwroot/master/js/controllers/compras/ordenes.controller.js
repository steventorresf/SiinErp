(function () {
    ...
    AppController.$inject = ['$location', '$cookies', '$scope', 'ComOrdenesService', 'ComOrdenesDetService', 'GenTercerosService', 'CarPlazosPagoService', 'GenTablasDetService', 'InvArticulosService', 'GenTiposDocService'];
