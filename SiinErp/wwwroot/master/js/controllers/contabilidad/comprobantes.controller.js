(function () {
    ...
    AppController.$inject = ['$location', '$scope', '$cookies', 'ContTipoDocService', 'GenTerceroService', 'GenTablaDetService', 'ContRetencionService', 'ContPlanDeCuentaService', 'ContComprobanteService', 'ContComprobanteDetService'];
