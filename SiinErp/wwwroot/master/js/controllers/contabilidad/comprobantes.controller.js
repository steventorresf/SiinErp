(function () {
    ...
    AppController.$inject = ['$location', '$scope', '$cookies', 'ContTiposDocService', 'GenTercerosService', 'GenTablasDetService', 'ContRetencionService', 'ContPlanDeCuentaService', 'ContComprobantesService', 'ContComprobantesDetService'];
